...
#' @param dateModified character; required: FALSE; Timestamp when the entity was
#'    last updated. Coded in the ISO 8601 standard extended format, where date,
#'    time and time zone information needs to be provided (check for example
#'    https://www.w3.org/TR/NOTE-datetime).
...
#'
#' The Examples Section shows an example of how to construct the `externalReferences`
#' argument as a data.frame.
...
#' @param listOwnerName character; required: FALSE; Human readable name of a List
#'    Owner (usually a user or person).
#' @param listOwnerPersonDbId character; required: FALSE; The unique identifier
#'    for a List Owner (usually a user or person).
#' @param listSize integer; required: FALSE; The number of elements in a List.
#' @param listSource character; required: FALSE; The description of where a List
#'    originated from.
#' @param listType character; required: FALSE; default: &quot;&quot;, other
#'    possible values: &quot;germplasm&quot;|&quot;markers&quot;|&quot;observations
