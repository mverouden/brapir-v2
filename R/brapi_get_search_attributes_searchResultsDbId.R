...
#'
#' @details Get the results of a Germplasm `Attributes` search request.
#'
#' @return data.frame
#'
#' @author Maikel Verouden
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Germplasm/2.0#/Germplasm%20Attributes/get_search_attributes__searchResultsDbId_}{BrAPI SwaggerHub}
#'
...
#'
#' @export
brapi_get_search_attributes_searchResultsDbId <- function(con = NULL,
                                                          searchResultsDbId = '',
                                                          page = 0,
                                                          pageSize = 1000) {
  ...
  callurl <- brapirv2:::brapi_GET_callURL(usedArgs = usedArgs,
                                          callPath = "/search/attributes/{searchResultsDbId}",
  ...
  ## Set class of output
  class(out) <- c(class(out), "brapi_get_search_attributes_searchResultsDbId")
