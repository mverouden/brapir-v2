...
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Core/2.0#/Locations/get_search_locations__searchResultsDbId_ }{BrAPI SwaggerHub}
#'
#' @family brapi-core
#' @family Locations
#'
...
#' brapi_get_search_locations_searchResultsDbId(con = con, searchResultsDbId = "")
#' }
#'
#' @export
brapi_get_search_locations_searchResultsDbId <- function(con = NULL, searchResultsDbId = '', page = 0, pageSize = 1000) {
  ...
  callurl <- brapir:::brapi_GET_callURL(usedArgs = usedArgs,
                                        callPath = "/search/locations/{searchResultsDbId}",
  ...
  ## Set class of output
  class(out) <- c(class(out), "brapi_get_search_locations_searchResultsDbId")
