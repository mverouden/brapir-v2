...
#'
#' @export
brapi_get_studies <- function(con = NULL, commonCropName = '', studyType = '', programDbId = '', locationDbId = '', seasonDbId = '', trialDbId = '', studyDbId = '', studyName = '', studyCode = '', studyPUI = '', germplasmDbId = '', observationVariableDbId = '', active = NA, sortBy = '', sortOrder = '', externalReferenceID = '', externalReferenceSource = '', page = 0, pageSize = 1000) {
