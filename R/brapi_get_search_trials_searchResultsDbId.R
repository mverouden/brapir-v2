...
#'
#' @details Returns the result of the advanced searching for the trials
#'    resource.
#'
#' @return data.frame
#'
...
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Core/2.0#/Trials/get_search_trials__searchResultsDbId_ }{BrAPI SwaggerHub}
#'
#' @family brapi-core
#' @family Trials
#'
...
brapi_get_search_trials_searchResultsDbId <- function(con = NULL,
  ...
  callurl <- brapirv2:::brapi_GET_callURL(usedArgs = usedArgs,
                                        callPath = "/search/trials/{searchResultsDbId}",
  ...
  ## Set class of output
  class(out) <- c(class(out), "brapi_get_search_trials_searchResultsDbId")
