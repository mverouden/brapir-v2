...
#'
#' @details Get the results of a `ReferenceSets` search request.
#'
#' @return data.frame
#'
#' @author Maikel Verouden
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Genotyping/2.0#/Reference%20Sets/get_search_referencesets__searchResultsDbId_ }{BrAPI SwaggerHub}
#'
...
#'
#' @export
brapi_get_search_referencesets_searchResultsDbId <- function(con = NULL,
                                                             searchResultsDbId = '',
                                                             page = 0,
                                                             pageSize = 1000) {
  ...
  callurl <- brapirv2:::brapi_GET_callURL(usedArgs = usedArgs,
                                          callPath = "/search/referencesets/{searchResultsDbId}",
  ...
  ## Set class of output
  class(out) <- c(class(out), "brapi_get_search_referencesets_searchResultsDbId")
