...
#' @param traitDbId character; required: TRUE; Identifier for the trait to
#'    update details of.
...
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Phenotyping/2.0#/Traits/put_traits__traitDbId_ }{BrAPI SwaggerHub}
#'
...
#'
#' @export
brapi_put_traits_traitDbId <- function(con = NULL,
                                       traitDbId = '',
                                       additionalInfo = list(),
