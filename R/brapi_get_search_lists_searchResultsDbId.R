...
#'
#' @details Advanced searching for the list resource.
...
#' brapi_get_search_lists_searchResultsDbId(con = con, searchResultsDbId = "")
#' }
#'
#' @export
brapi_get_search_lists_searchResultsDbId <- function(con = NULL, searchResultsDbId = '', page = 0, pageSize = 1000) {
