...
#' brapi_get_search_people_searchResultsDbId(con = con, searchResultsDbId = "")
#' }
#'
#' @export
brapi_get_search_people_searchResultsDbId <- function(con = NULL, searchResultsDbId = '', page = 0, pageSize = 1000) {
