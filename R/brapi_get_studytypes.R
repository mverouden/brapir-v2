...
#'
#' @details Call to retrieve the list of study types.
#'
#' @return data.frame
#'
#' @author Maikel Verouden
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Core/2.0#/Studies/get_studytypes }{BrAPI SwaggerHub}
#'
#' @family brapi-core
#' @family Studies
#'
...
#' brapi_get_studytypes(con = con)
#' }
#'
#' @export
brapi_get_studytypes <- function(con = NULL, page = 0, pageSize = 1000) {
  ...
  try({
    ...
    colnames(out) <- "Study Types"
  })
  ## Set class of output
  class(out) <- c(class(out), "brapi_get_studytypes")
