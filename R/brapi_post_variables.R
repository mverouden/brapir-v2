...
#'    . Either specify:
#'
#'    * `methodDbId` character; required: FALSE; Method unique identifier to use
#'        a predefined method.
#'
#'    or create a new method by specifying (will generate the `methodDbId`
#'    automatically):
#'
...
#'        to use.
#'
#'    or create a new scale by specifying (will generate the `scaleDbId`
#'    automatically):
#'
#'    * `additionalInfo` list; required: FALSE; Additional arbitrary information
#'        . If provided use the following construct list(additionalProp1 =
...
#'        identifies a trait.
#'
#'    or create a new trait by specifying (will generate the `traitDbId`
#'    automatically):
#'
#'    * `additionalInfo` list; required: FALSE; Additional arbitrary information
#'        . If provided use the following construct list(additionalProp1 =
...
#'
#' @details Add a new Observation Variables to the system.
#'
#' @return data.frame
#'
#' @author Maikel Verouden
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Phenotyping/2.0#/Observation%20Variables/post_variables }{BrAPI SwaggerHub}
#'
...
#'
#' @export
brapi_post_variables <- function(con = NULL,
                                 additionalInfo = list(),
                                 commonCropName = '',
                                 contextOfUse = '',
                                 defaultValue = '',
  ...
  ## Set class of output
  class(out) <- c(class(out), "brapi_post_variables")
