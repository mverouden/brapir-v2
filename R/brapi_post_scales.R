...
#'
#' @details Create new scale objects in the database
#'
#' @return data.frame
#'
#' @author Maikel Verouden
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Phenotyping/2.0#/Scales/post_scales }{BrAPI SwaggerHub}
#'
...
#'
#' @export
brapi_post_scales <- function(con = NULL,
                              additionalInfo = list(),
                              dataType = '',
                              decimalPlaces = 0,
                              externalReferences = '',
