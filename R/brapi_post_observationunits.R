...
#'    trial.
#'
#' @details Add new Observation Units
#'
#' @return data.frame
#'
#' @author Maikel Verouden
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Phenotyping/2.0#/Observation%20Units/post_observationunits }{BrAPI SwaggerHub}
#'
...
#'
#' @export
brapi_post_observationunits <- function(con = NULL,
                                        additionalInfo = list(),
                                        externalReferences = '',
                                        germplasmDbId = '',
                                        germplasmName = '',
  ...
  ## Set class of output
  class(out) <- c(class(out), "brapi_post_observationunits")
