...
#'    trial.
#'
#' @details Update an existing Study with new data
#'
#' @return data.frame
#'
#' @author Maikel Verouden
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Core/2.0#/Studies/put_studies__studyDbId_ }{BrAPI SwaggerHub}
#'
#' @family brapi-core
#' @family Studies
#'
...
#'                     trialName = trialName)
#'
#' brapi_get_studies_studyDbId(con = con, studyDbId = unique(out$studyDbId))
#'
#' active <- FALSE
#' additionalInfo <- list(dummyData = "True", example = "put_studies_studyDbId")
#' commonCropName <- "Tomatillo"
#' seasons <- c("spring_2012")
#'
#' brapi_put_studies_studyDbId(con = con,
#'                             studyDbId = unique(out$studyDbId),
#'                             active = active,
#'                             additionalInfo = additionalInfo,
#'                             commonCropName = commonCropName,
#'                             seasons = seasons)
...
#'
#' @export
brapi_put_studies_studyDbId <- function(con = NULL,
                                        studyDbId = '',
                                        active = NA,
                                        additionalInfo = list(),
                                        commonCropName = '',
  ...
  brapirv2:::brapi_checkArgs(usedArgs, reqArgs = "studyDbId")
  ## Obtain the call url
  ...
  ## Set class of output
  class(out) <- c(class(out), "brapi_put_studies_studyDbId")
