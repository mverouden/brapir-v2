...
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Phenotyping/2.0#/Images/get_search_images__searchResultsDbId_ }{BrAPI SwaggerHub}
#'
...
#'
#' @export
brapi_get_search_images_searchResultsDbId <- function(con = NULL,
                                                      searchResultsDbId = '',
                                                      page = 0,
                                                      pageSize = 1000) {
  ...
  callurl <- brapirv2:::brapi_GET_callURL(usedArgs = usedArgs,
                                          callPath = "/search/images/{searchResultsDbId}",
  ...
  ## Set class of output
  class(out) <- c(class(out), "brapi_get_search_images_searchResultsDbId")
