...
#' @param seasonDbId character; required: TRUE; The unique identifier for a season. For backward compatibility it can be a string like '2012', '1957-2004'
#'
...
#' brapi_get_seasons_seasonDbId(con = con, seasonDbId = "winter_2012")
#' }
#'
#' @export
brapi_get_seasons_seasonDbId <- function(con = NULL, seasonDbId = '') {
