...
#'
#' @details Get the results of a `MarkerPositions` search request.
#'
#' @return data.frame
#'
#' @author Maikel Verouden
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Genotyping/2.0#/Genome%20Maps/get_search_markerpositions__searchResultsDbId_ }{BrAPI SwaggerHub}
#'
...
#' brapi_get_search_markerpositions_searchResultsDbId(con = con,
#'                                                    searchResultsDbId = searchResultsDbId)
#' }
#'
#' @export
brapi_get_search_markerpositions_searchResultsDbId <- function(con = NULL,
                                                               searchResultsDbId = '',
                                                               page = 0,
                                                               pageSize = 1000) {
  ...
  callurl <- brapirv2:::brapi_GET_callURL(usedArgs = usedArgs,
                                          callPath = "/search/markerpositions/{searchResultsDbId}",
  ...
  ## Set class of output
  class(out) <- c(class(out), "brapi_get_search_markerpositions_searchResultsDbId")
