...
#'
#' @details Get the results of a `References` search request.
#'
#' @return data.frame
#'
#' @author Maikel Verouden
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Genotyping/2.0#/References/get_search_references__searchResultsDbId_ }{BrAPI SwaggerHub}
#'
...
#' brapi_get_search_references_searchResultsDbId(con = con,
#'                                               searchResultsDbId = searchResultsDbId)
#' }
#'
#' @export
brapi_get_search_references_searchResultsDbId <- function(con = NULL,
                                                          searchResultsDbId = '',
                                                          page = 0,
                                                          pageSize = 1000) {
  ...
  callurl <- brapirv2:::brapi_GET_callURL(usedArgs = usedArgs,
                                          callPath = "/search/references/{searchResultsDbId}",
  ...
  ## Set class of output
  class(out) <- c(class(out), "brapi_get_search_references_searchResultsDbId")
