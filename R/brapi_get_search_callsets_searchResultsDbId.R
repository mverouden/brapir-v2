...
#'
#' @details Returns the result of the advanced searching for the `CallSets`
#'    resource.
#'
#' @return data.frame
#'
...
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Genotyping/2.0#/Call%20Sets/get_search_callsets__searchResultsDbId_ }{BrAPI SwaggerHub}
#'
...
#' brapi_get_search_callsets_searchResultsDbId(con = con,
#'                                             searchResultsDbId = searchResultsDbId)
#' }
#'
#' @export
brapi_get_search_callsets_searchResultsDbId <- function(con = NULL,
                                                        searchResultsDbId = '',
                                                        page = 0,
                                                        pageSize = 1000) {
  ...
  callurl <- brapirv2:::brapi_GET_callURL(usedArgs = usedArgs,
                                          callPath = "/search/callsets/{searchResultsDbId}",
  ...
  ## Set class of output
  class(out) <- c(class(out), "brapi_get_search_callsets_searchResultsDbId")
