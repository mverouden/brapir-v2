...
#' @param traitDbId character; required: FALSE; The unique identifier for a
#'    trait.
...
#'
#' @details Call to retrieve a list of traits available in the system and their associated variables.
#'
#' @return data.frame
#'
#' @author Maikel Verouden
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Phenotyping/2.0#/Traits/get_traits }{BrAPI SwaggerHub}
#'
...
#' brapi_get_traits(con = con)
#' }
#'
#' @export
brapi_get_traits <- function(con = NULL,
                             traitDbId = '',
