...
#'    identifier.
#' @param traitClass character; required: FALSE; Variable's trait class
#'    (phenological, physiological, morphological, _etc._).
...
#'
#' @details Call to retrieve a list of observation variables available in the
#'    database system.
#'
#' @return data.frame
#'
...
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI-Phenotyping/2.0#/Observation%20Variables/get_variables }{BrAPI SwaggerHub}
#'
...
#' brapi_get_variables(con = con)
#' }
#'
#' @export
brapi_get_variables <- function(con = NULL,
